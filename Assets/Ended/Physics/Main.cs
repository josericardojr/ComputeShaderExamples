...
{ 
    ...
    void Start()
    {
        ...
        if (useGPU)
        {
            int totalsize = sizeof(float) * 2 + sizeof(float) * 6;
            ...
            cbStaticSphere = new ComputeBuffer(bufferStaticSpheres.Length, totalsize);
            cbStaticSphere.SetData(bufferStaticSpheres);
            computeShader.SetBuffer(0, "staticSphere", cbStaticSphere);
            ...
            computeShader.SetInt("sElements", bufferStaticSpheres.Length);
        }
